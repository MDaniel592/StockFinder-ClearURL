...
from unalix.__version__ import __version__
...
def create_ssl_context():
    ...
    ssl_verify_flags = ssl.VERIFY_X509_TRUSTED_FIRST | ssl.VERIFY_DEFAULT
...
package_data = os.path.join(os.path.dirname(__file__), "package_data")
...
body_redirects = (os.path.join(package_data, "body_redirects.json"),)

# Domains that require cookies to work properly
cookie_required = (os.path.join(package_data, "cookies_required.json"),)
